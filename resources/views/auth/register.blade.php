                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="wrap-input100 validate-input">
                                <input class="input100 @error('name') is-invalid @enderror" type="text" id="name" name="name" placeholder="Nama" alue="{{ old('name') }}" required autocomplete="name" autofocus>
                                @error('name')
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Enter E-mail">
                                <input class="input100 @error('email') is-invalid @enderror" id="email" type="text" name="email" placeholder="Alamat E-mail" value="{{ old('email') }}" required autocomplete="email">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Enter confirm password">
                                <input class="input100" id="password" tid="password-confirm" name="password_confirmation" type="password" placeholder="Konfirmasi Password" required autocomplete="new-password">
                                <span class="focus-input100" data-placeholder="&#xf191;"></span>
                            </div>
